 ...
 * @author DAIDAI
 */
public class Moyingxiangyunshujiedian_2 extends SlimefunItem {

    private static final Material material = Material.ENDER_CHEST;

    public Moyingxiangyunshujiedian_2(ItemGroup category, SlimefunItemStack item, RecipeType recipeType,
                                      ItemStack[] recipe) {
    ...
    public void preRegister() {
        this.addItemHandler(new BlockTicker() {
            public void tick(Block b, SlimefunItem sf, Config data) {
                Moyingxiangyunshujiedian_2.this.tick(b);
            }
