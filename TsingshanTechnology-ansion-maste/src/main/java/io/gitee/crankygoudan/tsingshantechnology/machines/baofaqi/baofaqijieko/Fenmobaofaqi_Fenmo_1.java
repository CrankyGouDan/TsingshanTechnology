package io.gitee.crankygoudan.tsingshantechnology.machines.baofaqi.baofaqijieko;

import io.gitee.crankygoudan.tsingshantechnology.jieko.Recipe;
...
public abstract class Fenmobaofaqi_Fenmo_1 extends SlimefunItem implements InventoryBlock, EnergyNetComponent, MachineProcessHolder<CraftingOperation> {
    ...
    protected Fenmobaofaqi_Fenmo_1(ItemGroup itemGroup, SlimefunItemStack item, RecipeType recipeType, ItemStack[] recipe) {
    ...
    public void preRegister() {
        addItemHandler(new BlockTicker() {
            ...
            public void tick(Block b, SlimefunItem item, Config data) {
                Fenmobaofaqi_Fenmo_1.this.tick(b);
            }
        });
    }
