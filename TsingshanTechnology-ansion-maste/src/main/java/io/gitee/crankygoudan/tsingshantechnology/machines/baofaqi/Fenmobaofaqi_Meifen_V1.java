...
public class Fenmobaofaqi_Meifen_V1 extends Fenmobaofaqi_Fenmo_1 {
    public Fenmobaofaqi_Meifen_V1(ItemGroup itemGroup, SlimefunItemStack item, RecipeType recipeType, ItemStack[] recipe) {
    ...
    public String getInvTitle() {
        return TextUtil.colorPseudorandomString("基础 镁粉爆发器");
    }
    ...
    public void registerDefaultRecipes() {
        ...
        this.registerRecipe(0, SlimefunItems.MAGNESIUM_DUST);
