...
public class Fenmobaofaqi_Xifen_V1 extends Fenmobaofaqi_Fenmo_1 {
    public Fenmobaofaqi_Xifen_V1(ItemGroup itemGroup, SlimefunItemStack item, RecipeType recipeType, ItemStack[] recipe) {
    ...
    public void registerDefaultRecipes() {
        ...
        this.registerRecipe(0, SlimefunItems.TIN_DUST);
