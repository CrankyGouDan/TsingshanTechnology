...
import io.gitee.crankygoudan.tsingshantechnology.machines.baofaqi.baofaqijieko.Qianyinghebaofaqi_2;
...
public class Qianyinghebaofaqi_V2 extends Qianyinghebaofaqi_2 {
    public Qianyinghebaofaqi_V2(ItemGroup itemGroup, SlimefunItemStack item, RecipeType recipeType, ItemStack[] recipe) {
    ...
    public String getInvTitle() {
        return TextUtil.colorPseudorandomString("高级 潜影盒爆发器");
    }
