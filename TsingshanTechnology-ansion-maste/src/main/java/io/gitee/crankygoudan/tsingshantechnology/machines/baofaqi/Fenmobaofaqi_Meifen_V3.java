...
public class Fenmobaofaqi_Meifen_V3 extends Fenmobaofaqi_Fenmo_1 {
    public Fenmobaofaqi_Meifen_V3(ItemGroup itemGroup, SlimefunItemStack item, RecipeType recipeType, ItemStack[] recipe) {
    ...
    public String getInvTitle() {
        return TextUtil.colorPseudorandomString("究极 镁粉爆发器");
    }
    ...
    public void registerDefaultRecipes() {
        ...
        registerRecipe(0, new SlimefunItemStack ( SlimefunItems.MAGNESIUM_DUST,64));
