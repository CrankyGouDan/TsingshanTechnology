...
public class Fenmobaofaqi_Jinfen_V1 extends Fenmobaofaqi_Fenmo_1 {
    public Fenmobaofaqi_Jinfen_V1(ItemGroup itemGroup, SlimefunItemStack item, RecipeType recipeType, ItemStack[] recipe) {
    ...
    public String getInvTitle() {
        return TextUtil.colorPseudorandomString("基础 金粉爆发器");
    }
    ...
    public void registerDefaultRecipes() {
        ...
        this.registerRecipe(0, SlimefunItems.GOLD_DUST);
