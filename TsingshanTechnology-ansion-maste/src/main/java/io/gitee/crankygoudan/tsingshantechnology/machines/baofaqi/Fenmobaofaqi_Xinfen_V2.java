...
public class Fenmobaofaqi_Xinfen_V2 extends Fenmobaofaqi_Fenmo_1 {
    public Fenmobaofaqi_Xinfen_V2(ItemGroup itemGroup, SlimefunItemStack item, RecipeType recipeType, ItemStack[] recipe) {
    ...
    public String getInvTitle() {
        return TextUtil.colorPseudorandomString("高级 锌粉爆发器");
    }
    ...
    public void registerDefaultRecipes() {
        ...
        registerRecipe(0, new SlimefunItemStack ( SlimefunItems.ZINC_DUST,8));
