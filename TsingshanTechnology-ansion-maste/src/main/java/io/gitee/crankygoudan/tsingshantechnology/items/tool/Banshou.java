...
public final class Banshou extends SimpleSlimefunItem<ItemUseHandler> implements NotPlaceable {

    private final CoolDowns coolDowns = new CoolDowns(50);

    public Banshou(ItemGroup category, SlimefunItemStack item, RecipeType type, ItemStack[] recipe) {
