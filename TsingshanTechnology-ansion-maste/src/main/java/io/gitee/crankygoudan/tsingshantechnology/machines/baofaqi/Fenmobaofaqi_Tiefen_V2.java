...
public class Fenmobaofaqi_Tiefen_V2 extends Fenmobaofaqi_Fenmo_1 {
    public Fenmobaofaqi_Tiefen_V2(ItemGroup itemGroup, SlimefunItemStack item, RecipeType recipeType, ItemStack[] recipe) {
    ...
    public String getInvTitle() {
        return TextUtil.colorPseudorandomString("高级 铁粉爆发器");
    }
    ...
    public void registerDefaultRecipes() {
        ...
        registerRecipe(0, new SlimefunItemStack ( SlimefunItems.IRON_DUST,8));
