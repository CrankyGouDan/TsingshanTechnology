...
public abstract class Qianyinghebaofaqi_1 extends SlimefunItem implements InventoryBlock, EnergyNetComponent, MachineProcessHolder<CraftingOperation> {
    ...
    protected Qianyinghebaofaqi_1(ItemGroup itemGroup, SlimefunItemStack item, RecipeType recipeType, ItemStack[] recipe) {
    ...
    public void preRegister() {
        addItemHandler(new BlockTicker() {
            ...
            public void tick(Block b, SlimefunItem item, Config data) {
                Qianyinghebaofaqi_1.this.tick(b);
            }
        });
    }
