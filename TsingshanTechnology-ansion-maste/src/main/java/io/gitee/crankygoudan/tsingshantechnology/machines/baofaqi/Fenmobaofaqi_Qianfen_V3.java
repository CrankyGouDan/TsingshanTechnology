...
public class Fenmobaofaqi_Qianfen_V3 extends Fenmobaofaqi_Fenmo_1 {
    public Fenmobaofaqi_Qianfen_V3(ItemGroup itemGroup, SlimefunItemStack item, RecipeType recipeType, ItemStack[] recipe) {
    ...
    public String getInvTitle() {
        return TextUtil.colorPseudorandomString("究极 铅粉爆发器");
    }
    ...
    public void registerDefaultRecipes() {
        ...
        registerRecipe(0, new SlimefunItemStack ( SlimefunItems.LEAD_DUST,64));
