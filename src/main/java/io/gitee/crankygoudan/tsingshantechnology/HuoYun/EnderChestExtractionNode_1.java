 ...
 */
public class EnderChestExtractionNode_1 extends SlimefunItem {

    private static final Material material = Material.ENDER_CHEST;

    public EnderChestExtractionNode_1(ItemGroup category, SlimefunItemStack item, RecipeType recipeType, ItemStack[] recipe) {
    ...
    public void preRegister() {
        this.addItemHandler(new BlockTicker() {
            public void tick(Block b, SlimefunItem sf, Config data) {
                EnderChestExtractionNode_1.this.tick(b);
            }
