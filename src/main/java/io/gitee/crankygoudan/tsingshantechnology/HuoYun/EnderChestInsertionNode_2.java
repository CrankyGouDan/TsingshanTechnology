 ...
 */
public class EnderChestInsertionNode_2 extends SlimefunItem {

    private static final Material material = Material.ENDER_CHEST;

    public EnderChestInsertionNode_2(ItemGroup category, SlimefunItemStack item, RecipeType recipeType,
                                     ItemStack[] recipe) {
    ...
    public void preRegister() {
        this.addItemHandler(new BlockTicker() {
            public void tick(Block b, SlimefunItem sf, Config data) {
                EnderChestInsertionNode_2.this.tick(b);
            }
