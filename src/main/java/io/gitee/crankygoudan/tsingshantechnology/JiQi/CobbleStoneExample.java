...
public class CobbleStoneExample extends Cobblestone {
    public CobbleStoneExample(ItemGroup itemGroup, SlimefunItemStack item, RecipeType recipeType, ItemStack[] recipe) {
