 ...
 */
public class Yuangujitan extends SlimefunItem implements EnergyNetComponent {
    ...
    public Yuangujitan(ItemGroup category, SlimefunItemStack item, RecipeType recipeType, ItemStack[] recipe) {
        super(category, item, recipeType, recipe);

        new BlockMenuPreset(getId(), "&b&l全自动远古祭坛") {
