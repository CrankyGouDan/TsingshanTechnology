 ...
 */
public class Yuanbangongzuoxiang extends SlimefunItem implements EnergyNetComponent {

    public static final int ENERGY_CONSUMPTION = 512;
    public static final int CAPACITY = ENERGY_CONSUMPTION * 2;
    ...
    public Yuanbangongzuoxiang(ItemGroup category, SlimefunItemStack item, RecipeType recipeType, ItemStack[] recipe) {
        super(category, item, recipeType, recipe);

        new BlockMenuPreset(getId(), "&b&l全自动工作台(原版)") {
    ...
    protected void constructMenu(BlockMenuPreset preset) {
        Yuangujitan.borders(preset, border, inputBorder, outputBorder);
    ...
    public void preRegister() {
        addItemHandler(new BlockTicker() {
            ...
            public void tick(Block b, SlimefunItem sf, Config data) {
                Yuanbangongzuoxiang.this.tick(b);
            }
