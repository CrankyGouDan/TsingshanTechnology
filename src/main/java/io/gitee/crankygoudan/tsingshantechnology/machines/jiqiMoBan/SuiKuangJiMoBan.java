...
public abstract class SuiKuangJiMoBan extends SlimefunItem implements InventoryBlock, EnergyNetComponent, MachineProcessHolder<CraftingOperation> {
    ...
    protected SuiKuangJiMoBan(ItemGroup category, SlimefunItemStack item, RecipeType recipeType, ItemStack[] recipe) {
    ...
    @ParametersAreNonnullByDefault
    protected SuiKuangJiMoBan(ItemGroup itemGroup, SlimefunItemStack item, RecipeType recipeType, ItemStack[] recipe, ItemStack recipeOutput) {
     ...
     */
    public final SuiKuangJiMoBan setCapacity(int capacity) {
     ...
     */
    public final SuiKuangJiMoBan setProcessingSpeed(int speed) {
     ...
     * @return This method will return the current instance of {@link AContainer}, so that can be chained.
     */
    public final SuiKuangJiMoBan setEnergyConsumption(int energyConsumption) {
