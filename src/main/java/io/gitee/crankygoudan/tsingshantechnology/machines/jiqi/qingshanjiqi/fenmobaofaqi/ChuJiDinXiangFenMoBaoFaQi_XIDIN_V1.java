...
public class ChuJiDinXiangFenMoBaoFaQi_XIDIN_V1 extends ChuJiDinXiangBaoFaQiMoBan {
    public ChuJiDinXiangFenMoBaoFaQi_XIDIN_V1(ItemGroup itemGroup, SlimefunItemStack item, RecipeType recipeType, ItemStack[] recipe) {
    ...
    public String getInvTitle() {
        return Y.colorPseudorandomString("初级定向锡锭爆发器");
    }
    ...
    public void registerDefaultRecipes() {
        ...
        this.registerRecipe(1, SlimefunItems.TIN_INGOT);
