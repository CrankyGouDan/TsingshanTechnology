...
public abstract class SuiKuangJiMoBan_V2 extends SlimefunItem implements InventoryBlock, EnergyNetComponent, MachineProcessHolder<CraftingOperation> {

    private static final int[] BORDER = {2, 11, 20, 29, 38};
    private static final int[] BORDER_IN = {1,10, 19, 28, 37};
    private static final int[] BORDER_OUT = { 3, 8, 12, 17, 21, 26, 30, 35, 39, 44};
    ...
    protected SuiKuangJiMoBan_V2(ItemGroup category, SlimefunItemStack item, RecipeType recipeType, ItemStack[] recipe) {
    ...
    @ParametersAreNonnullByDefault
    protected SuiKuangJiMoBan_V2(ItemGroup itemGroup, SlimefunItemStack item, RecipeType recipeType, ItemStack[] recipe, ItemStack recipeOutput) {
     ...
     */
    public final SuiKuangJiMoBan_V2 setCapacity(int capacity) {
     ...
     */
    public final SuiKuangJiMoBan_V2 setProcessingSpeed(int speed) {
     ...
     * @return This method will return the current instance of {@link AContainer}, so that can be chained.
     */
    public final SuiKuangJiMoBan_V2 setEnergyConsumption(int energyConsumption) {
    ...
    public int[] getOutputSlots() {
        return new int[] {4, 5, 6, 7, 13, 14, 15, 16,22,23,24,25,31,32,33,34,40,41,42,43 };
    }
    ...
    public void preRegister() {
        addItemHandler(new BlockTicker() {
            ...
            public void tick(Block b, SlimefunItem sf, Config data) {
                SuiKuangJiMoBan_V2.this.tick(b);
            }
