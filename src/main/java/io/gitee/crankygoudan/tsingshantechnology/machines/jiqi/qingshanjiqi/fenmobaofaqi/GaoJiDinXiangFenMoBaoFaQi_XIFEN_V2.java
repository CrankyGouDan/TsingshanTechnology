...
public class GaoJiDinXiangFenMoBaoFaQi_XIFEN_V2 extends ChuJiDinXiangBaoFaQiMoBan {
    public GaoJiDinXiangFenMoBaoFaQi_XIFEN_V2(ItemGroup itemGroup, SlimefunItemStack item, RecipeType recipeType, ItemStack[] recipe) {
    ...
    public String getInvTitle() {
        return Y.colorPseudorandomString("高级定向锡粉爆发器");
    }
    ...
    public void registerDefaultRecipes() {
        ...
        registerRecipe(1, new SlimefunItemStack ( SlimefunItems.TIN_DUST,8));
