...
public class MuCaiZhiZaoJi extends QianYingHeMoBan {
    public MuCaiZhiZaoJi(ItemGroup itemGroup, SlimefunItemStack item, RecipeType recipeType, ItemStack[] recipe) {
    ...
    public String getInvTitle() {
        return Y.colorPseudorandomString("木材制造机");
    }
    ...
    public void registerDefaultRecipes() {
        ...
        this.registerRecipe(0, Material.OAK_LOG);
